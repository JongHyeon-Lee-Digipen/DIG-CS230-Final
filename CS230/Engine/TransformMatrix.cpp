...
/*
Todo Reset
This should set the matrix to the identity matrix
*/
...
/*
Todo TranslateMatrix constructor
This should build a matrix using the vector input so it will perform a translation
*/
