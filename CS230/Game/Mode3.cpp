...
void Mode3::Load() 
{
	...
	super_rect2_1 = new Super_Rect2({ (Engine::GetWindow().GetSize().x / 7.0) + RectStart, 400 }, 2.41, 3);
	super_rect3_1 = new Super_Rect3({ (Engine::GetWindow().GetSize().x / 3.4) + RectStart, 600 }, 0.94, 3);
	super_rect4_1 = new Super_Rect4({ (Engine::GetWindow().GetSize().x / 2.25) + RectStart, 400 }, 5.57, 3);
	super_rect1_1->Load();
	super_rect2_1->Load();
	super_rect3_1->Load();
	super_rect4_1->Load();
